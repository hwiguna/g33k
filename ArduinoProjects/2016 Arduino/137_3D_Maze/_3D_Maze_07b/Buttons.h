...
void MoveForward()
{
  ...
  if (youDir == 1 && youCol < 7 && !Look(youRow, youCol + 1)) youColDir = +1; // Facing East
  if (youDir == 2 && youRow < 7 && !Look(youRow + 1, youCol)) youRowDir = +1; // Facing South
...
void MoveBackward()
{
  if (youDir == 0 && youRow < 7 && !Look(youRow + 1, youCol)) youRowDir = +1; // Facing North
  ...
  if (youDir == 3 && youCol < 7 && !Look(youRow, youCol + 1)) youColDir = +1; // Facing West
  if (youRowDir == 0 && youColDir == 0)
    Beep();
  else {
    zoom = hInset;
