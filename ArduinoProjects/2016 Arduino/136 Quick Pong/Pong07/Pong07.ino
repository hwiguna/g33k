...
//== Game variables ==
u8g_uint_t courtWidth,courtHeight, halfCourtWidth, x,y, dx,dy, py0,py1, score0, score1;
...
void setup(void) {
  ...
  u8g.setFont(u8g_font_04b_03b); //u8g_font_unifont
...
void DrawScore()
{
  ...
  char strScore0[2];
  char strScore1[2];
  String str = String(score0);
  str.toCharArray(strScore0,2);
  str = String(score1);
  str.toCharArray(strScore1,2);
