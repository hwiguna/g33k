...
const int scePin = 10; // 7;   // SCE - Chip select, pin 3 on LCD.
const int rstPin = 9;  // 6;   // RST - Reset, pin 4 on LCD.
const int dcPin = 8;   //5;    // DC - Data/Command, pin 5 on LCD.
const int sdinPin = 11;  // DN(MOSI) - Serial data, pin 6 on LCD.
const int sclkPin = 13;  // SCLK - Serial clock, pin 7 on LCD.
const int blPin = 7; // 9;    // LED - Backlight LED, pin 8 on LCD.
