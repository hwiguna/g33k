...
// v5 - do not divide by 100000 until we need the data. :-(
// v6 - removed global fix_age. try commenting out Phone code
...
void getLatLong()
{
  ...
  Serial.print(latitude/100000, 5); //GPS LAT
  Serial.print(",");  //comma between the LAT and LON is needed for google maps
  Serial.println(longitude/100000, 5); //GPS Lon
}
...
void SubmitHttpPost()
{
  ...
  url += String(latitude/100000, 5);
  url += "&Lon=";
  url += String(longitude/100000, 5);
  url += "\"";
