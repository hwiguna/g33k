...
void PrintAt(int x, int y, String str)
{
  for (int i = 0; i < str.length(); i++)
  {
    ...
    OLED_Text2x_128128RGB(x + (i * 7 * 2), y, str[i] - 32, WHITE, BLACK);
  }
}
...
void loop()                                         // main loop, runs after "setup()"
{
  ...
  PrintAt(10, 128-16, String("2X!"));
  PrintAt(10, 128-16-4-16, String(kount++));
  PrintAt(10, 128-16-4-16-4-16, "Fun, fun");
