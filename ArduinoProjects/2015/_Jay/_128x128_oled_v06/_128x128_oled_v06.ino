...
// V06 - use unsigned char instead of int for speed.
...
http://www.newhavendisplay.com/color_oleds.html
...
void setup()                                       // for Arduino, runs first at power on
{
  ...
  digitalWrite(CS_PIN, LOW);                     // set CS_PIN to ALWAYS select the OLED
