...
#define SERVOFAKTORLEFT 600 // 650. Larger # = wider wipe angle
#define SERVOFAKTORRIGHT 650 // 650

// Zero-position of left and right servo
// When in calibration mode, adjust the NULL-values so that the servo arms are at all times parallel
// either to the X or Y axis
#define SERVOLEFTNULL 2200 //Hari:2200. Orig:2250 larger# = clockwise
#define SERVORIGHTNULL 600 //Hari:600.  Orig:920 Smaller# = clockwise
...
#define LIFT1 1200  // Hari:1055. Orig:925  between numbers (park pen inside sweeper)
